#ifndef __MONTE_CARLO_DIGITAL_HPP
#define __MONTE_CARLO_DIGITAL_HPP

#include "../monte_carlo.hpp"
#include <vector>

class MonteCarloDigital : public MonteCarloBase
{
public:
    MonteCarloDigital(const unsigned long num_sims,
                       Option *pOption,
                       StatisticalDistribution *sd);

    virtual ~MonteCarloDigital();
